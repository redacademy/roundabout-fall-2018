 ...
 *
 * @package   Roundabout_Business_Hours
 * @author    Ashleigh <ashleigh@redacademy.com>
 * @license   GPL-2.0+
 * @link      http://example.com
 * @copyright 2015 RED Academy
 *
 * @wordpress-plugin
 * Plugin Name:      Roundabout Business Hours Widget
 * Plugin URI:        http://www.redacademy.com/INhabi
 * Description:       A nifty business hours widget built custom for the Roundabout site.
 * Version:           1.0.0
 * Author:            Ashleigh More-Hattia
...
class Roundabout_Biz_Hours extends WP_Widget {
     ...
     * @var      string
     */
    protected $widget_slug = 'roundabout-biz-hours';
...
add_action( 'widgets_init', function(){
     register_widget( 'Roundabout_Biz_Hours' );
});
