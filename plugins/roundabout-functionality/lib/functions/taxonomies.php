...
/**
  * Create "Team Members" taxonomies
**/
...
// Register Custom Taxonomy to create Featured Story

function featured_taxonomy() {

	$labels = array(
		'name'                       => _x( 'Featured Story', 'Taxonomy General Name', 'text_domain' ),
		'singular_name'              => _x( 'Featured Story', 'Taxonomy Singular Name', 'text_domain' ),
	...
	register_taxonomy( 'featured-story', array( 'stories' ), $args );
